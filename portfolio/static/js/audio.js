...
(function () {
  ...
  const THEMES = {
    ...
    projects: {
      ...
      swing: 0.2,
      arpPattern: "updown",
      arpWave: "square", // was "sawtooth" — shared harsh timbre with the lead was part of the mush
      arpMs: 200,
      arpGain: 0.32, // was 0.42 — comping shouldn't fight the lead for attention
      bassPattern: [0, 1, 0, 2],
      bassMs: 600,
      hatDensity: 0.5, // was 0.75 — busy enough to feel driven without burying everything else
      echoWet: 0.6,
      beatMs: 120, // was 105 — still the fastest theme on the site, just not overwhelming
      hatDiv: 1,
      arpDiv: 2,
      leadDiv: 3,
      counterDiv: 6, // was 5 — a 3-against-5 polyrhythm is genuinely one of the hardest for
      // the ear to parse; 3-against-6 (a clean 1:2) keeps the "driven" feel from the fast
      // tempo and swing without the beat relationship itself reading as chaos.
      bassDiv: 6,
      bassPhase: 3,
      pulseDiv: 12,
    },
    ...
    links: {
      root: 59, // B3 — crisp, direct, straightforward
      scale: [0, 2, 4, 5, 7, 9, 11, 12], // full diatonic major — the odd one out (everyone else is pentatonic-based), matching a simple resource list rather than a mood piece
      progression: [0, 4, 3, 6],
      motif: [0, 4, 2, 5],
      chordMs: 8500,
      noteMs: 560,
